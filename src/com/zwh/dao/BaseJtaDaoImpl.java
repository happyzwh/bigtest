...
public class BaseJtaDaoImpl<T> implements BaseDao{
	...
	public int save(Class T, Object o) throws BasicException {
		...
		try{
			...
			String dbName = DomainBeanUtil.getDbName(T);
			if(StringUtils.isNotBlank(dbName) && StringUtils.isNotBlank(tableName)){
			    ...
			    sql.append(" ) ");
			    pstmt = BasicJtaSessionFactory.getInstance().getSession(dbName).getConnection().prepareStatement(sql.toString());
			    if(!map.isEmpty()){
			    	int index = 1;
				    for(Map.Entry<String,Method> entry:map.entrySet()){
	...
	public Object get(Class T, Object o) throws BasicException {
		...
		try{
			...
			pstmt = BasicJtaSessionFactory.getInstance().getSession(dbName).getConnection().prepareStatement(sql.toString(),ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
			if(o instanceof Number || o instanceof String){
				if(o.getClass() == int.class || o.getClass()  == Integer.class  )pstmt.setInt(1, (Integer)o);
				else if(o.getClass() == long.class || o.getClass()  == Long.class  )pstmt.setLong(1, (Long)o);
				else if(o.getClass() == String.class || o.getClass()  == char.class  )pstmt.setString(1, (String)o);
	...
	public List list(Class T,String sqlStr,Object[] param) throws BasicException {
		...
		try{
			if(StringUtils.isNotBlank(sqlStr)){
				String dbName = DomainBeanUtil.getDbName(T);
				pstmt = BasicJtaSessionFactory.getInstance().getSession(dbName).getConnection().prepareStatement(sqlStr,ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);			
